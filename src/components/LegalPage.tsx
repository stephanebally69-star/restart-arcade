...
export function LegalPage({
  ...
  return (
    <Section className="pt-10 md:pt-14">
      ...
      <div className="legal mt-10 max-w-3xl space-y-5 text-ink-soft [&_a]:text-amber-700 [&_a]:underline [&_h2]:mt-10 [&_h2]:font-serif [&_h2]:text-xl [&_h2]:text-heading [&_li]:ml-5 [&_li]:list-disc [&_strong]:text-heading">
        {children}
      </div>
    </Section>
  )
