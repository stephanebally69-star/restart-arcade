<!-- source: https://restart-arcade.fr/rgpd-2/ | extrait le 2026-09-08 -->
...
RGPD
ARTICLE 1 : PRÉAMBULE
Cette politique de confidentialité s’applique au site : restart-arcade.fr
...
Cette politique de confidentialité complète les mentions légales  que les utilisateurs peuvent consulter à l’adresse ci-après en pied de page.
...
Les données à caractère personnel collectées sur le site RESTART sont les suivantes :
– Prénoms, noms
– Adresse mail
– Numéro de téléphone
Ces données sont collectées lorsque l’utilisateur effectue l’une des opérations suivantes sur le site :
– Lorsque l’utilisateur utilise la rubrique « DEVIS » sur la page d’accueil du site Web et sur la page « DEVIS ».
...
Les données récoltées auront pour unique but de répondre aux demandes des visiteurs du site qui auront utilisé la rubrique contact, et de procéder à des relances commerciales si nécessaire.
...
Le site RESTART est hébergé par : OVH, dont le siège est situé à l’adresse ci-après :
...
Le responsable du traitement des données à caractère personnel est : Mme Félix. Elle peut être contactée de la manière suivante :
Le responsable du traitement des données peut être contacté à contact@restart-arcade.fr
...
2.DONNÉES PERSONNELLES DES PERSONNES MINEURES
...
Il est porté à la connaissance de l’utilisateur que la dernière mise à jour de la présente politique de confidentialité est intervenue le : 06/08/2019.
